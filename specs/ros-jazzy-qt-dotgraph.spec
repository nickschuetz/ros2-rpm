...
Version:        2.7.6
Release:        1%{?dist}
Summary:        ROS 2 Jazzy qt_dotgraph

License:        BSD-3-Clause
URL:            http://ros.org/wiki/qt_dotgraph
Source0:        https://github.com/ros2-gbp/qt_gui_core-release/archive/refs/tags/release/jazzy/qt_dotgraph/2.7.6-1.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
%prep
%autosetup -p1 -n qt_gui_core-release-release-jazzy-qt_dotgraph-2.7.6-1
