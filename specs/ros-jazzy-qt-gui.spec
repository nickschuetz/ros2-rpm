...
Name:           ros-%{ros_distro}-qt-gui
Version:        2.7.6
Release:        1%{?dist}
Summary:        ROS 2 Jazzy qt_gui

License:        BSD-3-Clause
URL:            http://ros.org/wiki/qt_gui
Source0:        https://github.com/ros2-gbp/qt_gui_core-release/archive/refs/tags/release/jazzy/qt_gui/2.7.6-1.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
interface based on Qt. It is extensible with Python- and C++-based plugins
(implemented in separate packages) which can contribute arbitrary widgets.
It requires either PyQt or PySide bindings.

%prep
%autosetup -p1 -n qt_gui_core-release-release-jazzy-qt_gui-2.7.6-1
