...
Version:        4.1.1
Release:        1%{?dist}
Summary:        ROS 2 Jazzy vision_msgs

License:        Apache-2.0
URL:            https://github.com/ros2-gbp/vision_msgs-release
Source0:        https://github.com/ros2-gbp/vision_msgs-release/archive/refs/tags/release/jazzy/vision_msgs/4.1.1-3.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
%prep
%autosetup -p1 -n vision_msgs-release-release-jazzy-vision_msgs-4.1.1-3
...
%changelog
* Fri May 08 2026 Nick Schuetz <nschuetz@redhat.com> - 4.1.1-1
