...
Name:           ros-%{ros_distro}-qt-gui-py-common
Version:        2.7.6
Release:        1%{?dist}
Summary:        ROS 2 Jazzy qt_gui_py_common

License:        BSD-3-Clause
URL:            http://ros.org/wiki/qt_gui_py_common
Source0:        https://github.com/ros2-gbp/qt_gui_core-release/archive/refs/tags/release/jazzy/qt_gui_py_common/2.7.6-1.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
%prep
%autosetup -p1 -n qt_gui_core-release-release-jazzy-qt_gui_py_common-2.7.6-1
