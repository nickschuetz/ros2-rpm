...
Version:        28.1.9
Release:        1%{?dist}
Summary:        ROS 2 Jazzy rclcpp_action

License:        Apache-2.0
URL:            https://github.com/ros2-gbp/rclcpp-release
Source0:        https://github.com/ros2-gbp/rclcpp-release/archive/refs/tags/release/jazzy/rclcpp_action/28.1.9-1.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
%prep
%autosetup -p1 -n rclcpp-release-release-jazzy-rclcpp_action-28.1.9-1
