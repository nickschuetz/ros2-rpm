...
Name:           ros-%{ros_distro}-ros2run
Version:        0.40.7
Release:        1%{?dist}
Summary:        ROS 2 Lyrical ros2run

License:        Apache-2.0
URL:            https://github.com/ros2-gbp/ros2cli-release
Source0:        https://github.com/ros2-gbp/ros2cli-release/archive/refs/tags/release/lyrical/ros2run/0.40.7-1.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
%prep
%autosetup -p1 -n ros2cli-release-release-lyrical-ros2run-0.40.7-1
