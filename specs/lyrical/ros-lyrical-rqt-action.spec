...
Version:        2.5.0
Release:        1%{?dist}
Summary:        ROS 2 Lyrical rqt_action

License:        BSD-3-Clause
URL:            http://wiki.ros.org/rqt_action
Source0:        https://github.com/ros2-gbp/rqt_action-release/archive/refs/tags/release/lyrical/rqt_action/2.5.0-1.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
%prep
%autosetup -p1 -n rqt_action-release-release-lyrical-rqt_action-2.5.0-1
...
%changelog
* Wed Jun 03 2026 Nick Schuetz <nschuetz@redhat.com> - 2.5.0-1
