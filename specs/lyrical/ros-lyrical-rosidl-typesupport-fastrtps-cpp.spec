...
Version:        3.9.5
Release:        1%{?dist}
Summary:        ROS 2 Lyrical rosidl_typesupport_fastrtps_cpp

License:        Apache-2.0
URL:            https://github.com/ros2-gbp/rosidl_typesupport_fastrtps-release
Source0:        https://github.com/ros2-gbp/rosidl_typesupport_fastrtps-release/archive/refs/tags/release/lyrical/rosidl_typesupport_fastrtps_cpp/3.9.5-3.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
%prep
%autosetup -p1 -n rosidl_typesupport_fastrtps-release-release-lyrical-rosidl_typesupport_fastrtps_cpp-3.9.5-3
