...
Version:        3.3.1
Release:        1%{?dist}
Summary:        ROS 2 Lyrical pybind11_vendor

License:        Apache-2.0
URL:            https://github.com/pybind/pybind11
Source0:        https://github.com/ros2-gbp/pybind11_vendor-release/archive/refs/tags/release/lyrical/pybind11_vendor/3.3.1-3.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
%prep
%autosetup -p1 -n pybind11_vendor-release-release-lyrical-pybind11_vendor-3.3.1-3
...
%changelog
* Wed Jun 03 2026 Nick Schuetz <nschuetz@redhat.com> - 3.3.1-1
