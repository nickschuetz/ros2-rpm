...
Version:        5.2.1
Release:        1%{?dist}
Summary:        ROS 2 Lyrical rosidl_typesupport_interface
...
pushd rosidl_typesupport_interface > /dev/null
%cmake \
...
# Header-only interface package: ships headers only, no compiled library.
