...
%global pkg_name         rcl_logging_interface
%bcond fedora_fhs 0
%if %{with fedora_fhs}
...
Name:           ros-%{ros_distro}-rcl-logging-interface
Version:        3.4.1
Release:        1%{?dist}
Summary:        ROS 2 Lyrical rcl_logging_interface

License:        Apache-2.0
URL:            https://github.com/ros2-gbp/rcl_logging-release
Source0:        https://github.com/ros2-gbp/rcl_logging-release/archive/refs/tags/release/lyrical/rcl_logging_interface/3.4.1-3.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
%prep
%autosetup -p1 -n rcl_logging-release-release-lyrical-rcl_logging_interface-3.4.1-3
