...
%global pkg_name         rosidl_buffer_backend
%bcond fedora_fhs 0
%if %{with fedora_fhs}
...
Name:           ros-%{ros_distro}-rosidl-buffer-backend
Version:        5.2.1
Release:        1%{?dist}
Summary:        ROS 2 Lyrical rosidl_buffer_backend
...
pushd rosidl_buffer_backend > /dev/null
%cmake \
