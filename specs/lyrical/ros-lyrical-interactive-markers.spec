...
%global pkg_name         interactive_markers
%bcond fedora_fhs 0
%if %{with fedora_fhs}
...
Name:           ros-%{ros_distro}-interactive-markers
Version:        2.8.4
Release:        1%{?dist}
Summary:        ROS 2 Lyrical interactive_markers

License:        BSD-3-Clause
URL:            http://ros.org/wiki/interactive_markers
Source0:        https://github.com/ros2-gbp/interactive_markers-release/archive/refs/tags/release/lyrical/interactive_markers/2.8.4-1.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
%prep
%autosetup -p1 -n interactive_markers-release-release-lyrical-interactive_markers-2.8.4-1
...
%changelog
* Thu Jun 04 2026 Nick Schuetz <nschuetz@redhat.com> - 2.8.4-1
