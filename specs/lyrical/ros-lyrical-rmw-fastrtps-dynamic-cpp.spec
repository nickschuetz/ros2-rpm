...
Source0:        https://github.com/ros2-gbp/rmw_fastrtps-release/archive/refs/tags/release/lyrical/rmw_fastrtps_dynamic_cpp/9.4.8-1.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
%prep
%autosetup -p1 -n rmw_fastrtps-release-release-lyrical-rmw_fastrtps_dynamic_cpp-9.4.8-1
