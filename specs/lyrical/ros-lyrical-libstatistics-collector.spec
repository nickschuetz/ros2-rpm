...
Version:        2.1.2
Release:        1%{?dist}
Summary:        ROS 2 Lyrical libstatistics_collector

License:        Apache-2.0
URL:            https://github.com/ros2-gbp/libstatistics_collector-release
Source0:        https://github.com/ros2-gbp/libstatistics_collector-release/archive/refs/tags/release/lyrical/libstatistics_collector/2.1.2-1.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
%prep
%autosetup -p1 -n libstatistics_collector-release-release-lyrical-libstatistics_collector-2.1.2-1
...
%changelog
* Tue Jun 02 2026 Nick Schuetz <nschuetz@redhat.com> - 2.1.2-1
