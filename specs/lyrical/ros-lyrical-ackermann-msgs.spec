...
%global pkg_name         ackermann_msgs
%bcond fedora_fhs 0
%if %{with fedora_fhs}
...
Name:           ros-%{ros_distro}-ackermann-msgs
Version:        2.0.2
Release:        1%{?dist}
Summary:        ROS 2 Lyrical ackermann_msgs

License:        BSD-3-Clause
URL:            https://github.com/ros2-gbp/ackermann_msgs-release
Source0:        https://github.com/ros2-gbp/ackermann_msgs-release/archive/refs/tags/release/lyrical/ackermann_msgs/2.0.2-7.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
%prep
%autosetup -p1 -n ackermann_msgs-release-release-lyrical-ackermann_msgs-2.0.2-7
...
%changelog
* Tue Jun 02 2026 Nick Schuetz <nschuetz@redhat.com> - 2.0.2-1
