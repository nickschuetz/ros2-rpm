...
Version:        10.4.4
Release:        1%{?dist}
Summary:        ROS 2 Lyrical rcl_yaml_param_parser

License:        Apache-2.0
URL:            https://github.com/ros2-gbp/rcl-release
Source0:        https://github.com/ros2-gbp/rcl-release/archive/refs/tags/release/lyrical/rcl_yaml_param_parser/10.4.4-1.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
%prep
%autosetup -p1 -n rcl-release-release-lyrical-rcl_yaml_param_parser-10.4.4-1
