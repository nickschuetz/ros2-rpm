...
Source0:        https://github.com/ros2-gbp/rosidl_defaults-release/archive/refs/tags/release/lyrical/rosidl_default_generators/1.8.1-3.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
%prep
%autosetup -p1 -n rosidl_defaults-release-release-lyrical-rosidl_default_generators-1.8.1-3
