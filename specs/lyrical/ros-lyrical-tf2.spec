...
Version:        0.45.9
Release:        1%{?dist}
Summary:        ROS 2 Lyrical tf2

License:        BSD-3-Clause
URL:            http://www.ros.org/wiki/tf2
Source0:        https://github.com/ros2-gbp/geometry2-release/archive/refs/tags/release/lyrical/tf2/0.45.9-1.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
time, and lets the user transform points, vectors, etc between any two
coordinate frames at any desired point in time.

%prep
%autosetup -p1 -n geometry2-release-release-lyrical-tf2-0.45.9-1
