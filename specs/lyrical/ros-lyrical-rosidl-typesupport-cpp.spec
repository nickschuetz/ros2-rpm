...
Version:        3.4.2
Release:        1%{?dist}
Summary:        ROS 2 Lyrical rosidl_typesupport_cpp

License:        Apache-2.0
URL:            https://github.com/ros2-gbp/rosidl_typesupport-release
Source0:        https://github.com/ros2-gbp/rosidl_typesupport-release/archive/refs/tags/release/lyrical/rosidl_typesupport_cpp/3.4.2-3.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
Requires:       ros-lyrical-rosidl-generator-type-description
...
%prep
%autosetup -p1 -n rosidl_typesupport-release-release-lyrical-rosidl_typesupport_cpp-3.4.2-3
...
%changelog
* Tue Jun 02 2026 Nick Schuetz <nschuetz@redhat.com> - 3.4.2-1
