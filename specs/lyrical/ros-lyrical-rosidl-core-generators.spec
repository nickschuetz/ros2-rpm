...
Name:           ros-%{ros_distro}-rosidl-core-generators
Version:        0.4.3
Release:        1%{?dist}
Summary:        ROS 2 Lyrical rosidl_core_generators

License:        Apache-2.0
URL:            https://github.com/ros2-gbp/rosidl_core-release
Source0:        https://github.com/ros2-gbp/rosidl_core-release/archive/refs/tags/release/lyrical/rosidl_core_generators/0.4.3-3.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
Requires:       ros-lyrical-rosidl-cmake
Requires:       ros-lyrical-rosidl-generator-c
Requires:       ros-lyrical-rosidl-generator-cpp
Requires:       ros-lyrical-rosidl-generator-py
Requires:       ros-lyrical-rosidl-typesupport-c
Requires:       ros-lyrical-rosidl-typesupport-cpp
Requires:       ros-lyrical-rosidl-typesupport-fastrtps-c
Requires:       ros-lyrical-rosidl-typesupport-fastrtps-cpp
...
%prep
%autosetup -p1 -n rosidl_core-release-release-lyrical-rosidl_core_generators-0.4.3-3
