...
Version:        0.15.8
Release:        1%{?dist}
Summary:        ROS 2 Lyrical ament_cmake_ros

License:        Apache-2.0
URL:            https://github.com/ros2-gbp/ament_cmake_ros-release
Source0:        https://github.com/ros2-gbp/ament_cmake_ros-release/archive/refs/tags/release/lyrical/ament_cmake_ros/0.15.8-1.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
%prep
%autosetup -p1 -n ament_cmake_ros-release-release-lyrical-ament_cmake_ros-0.15.8-1
