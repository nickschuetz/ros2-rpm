...
Version:        2.4.5
Release:        1%{?dist}
Summary:        ROS 2 Lyrical action_msgs

License:        Apache-2.0
URL:            https://github.com/ros2-gbp/rcl_interfaces-release
Source0:        https://github.com/ros2-gbp/rcl_interfaces-release/archive/refs/tags/release/lyrical/action_msgs/2.4.5-1.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
BuildRequires:  ros-lyrical-unique-identifier-msgs
...
%prep
%autosetup -p1 -n rcl_interfaces-release-release-lyrical-action_msgs-2.4.5-1
