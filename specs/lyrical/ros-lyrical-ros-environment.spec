...
Version:        4.5.1
Release:        1%{?dist}
Summary:        ROS 2 Lyrical ros_environment

License:        Apache-2.0
URL:            https://github.com/ros/ros_environment
Source0:        https://github.com/ros2-gbp/ros_environment-release/archive/refs/tags/release/lyrical/ros_environment/4.5.1-1.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
%prep
%autosetup -p1 -n ros_environment-release-release-lyrical-ros_environment-4.5.1-1
...
%changelog
* Tue Jun 02 2026 Nick Schuetz <nschuetz@redhat.com> - 4.5.1-1
