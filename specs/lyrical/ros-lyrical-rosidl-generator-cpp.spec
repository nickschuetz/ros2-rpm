...
%global pkg_name         rosidl_generator_cpp
%bcond fedora_fhs 0
%if %{with fedora_fhs}
...
Name:           ros-%{ros_distro}-rosidl-generator-cpp
Version:        5.2.1
Release:        1%{?dist}
Summary:        ROS 2 Lyrical rosidl_generator_cpp
...
pushd rosidl_generator_cpp > /dev/null
%cmake \
