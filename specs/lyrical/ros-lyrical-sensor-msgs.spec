...
Source0:        https://github.com/ros2-gbp/common_interfaces-release/archive/refs/tags/release/lyrical/sensor_msgs/5.9.3-1.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
%prep
%autosetup -p1 -n common_interfaces-release-release-lyrical-sensor_msgs-5.9.3-1
