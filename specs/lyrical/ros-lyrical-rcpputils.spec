...
Version:        2.14.5
Release:        1%{?dist}
Summary:        ROS 2 Lyrical rcpputils

License:        Apache-2.0
URL:            https://github.com/ros2-gbp/rcpputils-release
Source0:        https://github.com/ros2-gbp/rcpputils-release/archive/refs/tags/release/lyrical/rcpputils/2.14.5-1.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
%prep
%autosetup -p1 -n rcpputils-release-release-lyrical-rcpputils-2.14.5-1
...
%changelog
* Tue Jun 02 2026 Nick Schuetz <nschuetz@redhat.com> - 2.14.5-1
