...
Name:           ros-%{ros_distro}-nav-msgs
Version:        5.9.2
Release:        1%{?dist}
Summary:        ROS 2 Lyrical nav_msgs

License:        Apache-2.0
URL:            https://github.com/ros2-gbp/common_interfaces-release
Source0:        https://github.com/ros2-gbp/common_interfaces-release/archive/refs/tags/release/lyrical/nav_msgs/5.9.2-3.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
%prep
%autosetup -p1 -n common_interfaces-release-release-lyrical-nav_msgs-5.9.2-3
