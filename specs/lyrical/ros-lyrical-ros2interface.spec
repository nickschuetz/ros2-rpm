...
Name:           ros-%{ros_distro}-ros2interface
Version:        0.40.7
Release:        1%{?dist}
Summary:        ROS 2 Lyrical ros2interface

License:        Apache-2.0
URL:            https://github.com/ros2-gbp/ros2cli-release
Source0:        https://github.com/ros2-gbp/ros2cli-release/archive/refs/tags/release/lyrical/ros2interface/0.40.7-1.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
Requires:       ros-lyrical-rosidl-adapter
...
%prep
%autosetup -p1 -n ros2cli-release-release-lyrical-ros2interface-0.40.7-1
...
%changelog
* Wed Jun 03 2026 Nick Schuetz <nschuetz@redhat.com> - 0.40.7-1
