...
Version:        1.8.0
Release:        1%{?dist}
Summary:        ROS 2 Lyrical spdlog_vendor

License:        Apache-2.0
URL:            https://github.com/gabime/spdlog
Source0:        https://github.com/ros2-gbp/spdlog_vendor-release/archive/refs/tags/release/lyrical/spdlog_vendor/1.8.0-3.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
%description
Wrapper around spdlog, providing nothing but a dependency on spdlog, on
some systems. On others, it provides an ExternalProject build of spdlog.

%prep
%autosetup -p1 -n spdlog_vendor-release-release-lyrical-spdlog_vendor-1.8.0-3
...
%changelog
* Tue Jun 02 2026 Nick Schuetz <nschuetz@redhat.com> - 1.8.0-1
