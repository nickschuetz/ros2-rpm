...
Name:           ros-%{ros_distro}-type-description-interfaces
Version:        2.4.5
Release:        1%{?dist}
Summary:        ROS 2 Lyrical type_description_interfaces

License:        Apache-2.0
URL:            https://github.com/ros2-gbp/rcl_interfaces-release
Source0:        https://github.com/ros2-gbp/rcl_interfaces-release/archive/refs/tags/release/lyrical/type_description_interfaces/2.4.5-1.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
BuildRequires:  ros-lyrical-rosidl-core-generators
...
%prep
%autosetup -p1 -n rcl_interfaces-release-release-lyrical-type_description_interfaces-2.4.5-1
...
%changelog
* Tue Jun 02 2026 Nick Schuetz <nschuetz@redhat.com> - 2.4.5-1
