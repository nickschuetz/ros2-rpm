...
%global pkg_name         visualization_msgs
%bcond fedora_fhs 0
%if %{with fedora_fhs}
...
Name:           ros-%{ros_distro}-visualization-msgs
Version:        5.9.2
Release:        1%{?dist}
Summary:        ROS 2 Lyrical visualization_msgs

License:        Apache-2.0
URL:            https://github.com/ros2-gbp/common_interfaces-release
Source0:        https://github.com/ros2-gbp/common_interfaces-release/archive/refs/tags/release/lyrical/visualization_msgs/5.9.2-3.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
%prep
%autosetup -p1 -n common_interfaces-release-release-lyrical-visualization_msgs-5.9.2-3
...
%changelog
* Thu Jun 04 2026 Nick Schuetz <nschuetz@redhat.com> - 5.9.2-1
