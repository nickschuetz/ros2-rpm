...
Version:        3.9.8
Release:        1%{?dist}
Summary:        ROS 2 Lyrical launch

License:        Apache-2.0
URL:            https://github.com/ros2-gbp/launch-release
Source0:        https://github.com/ros2-gbp/launch-release/archive/refs/tags/release/lyrical/launch/3.9.8-1.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
%prep
%autosetup -p1 -n launch-release-release-lyrical-launch-3.9.8-1
