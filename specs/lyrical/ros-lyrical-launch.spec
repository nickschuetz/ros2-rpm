...
Source0:        https://github.com/ros2-gbp/launch-release/archive/refs/tags/release/lyrical/launch/3.9.7-3.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
%prep
%autosetup -p1 -n launch-release-release-lyrical-launch-3.9.7-3
