...
Name:           ros-%{ros_distro}-laser-geometry
Version:        2.11.3
Release:        1%{?dist}
Summary:        ROS 2 Lyrical laser_geometry

License:        BSD-3-Clause
URL:            http://github.com/ros-perception/laser_geometry
Source0:        https://github.com/ros2-gbp/laser_geometry-release/archive/refs/tags/release/lyrical/laser_geometry/2.11.3-6.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
Requires:       ros-lyrical-eigen3-cmake-module
...
contains functionality to account for the skew resulting from moving robots
or tilting laser scanners.

%prep
%autosetup -p1 -n laser_geometry-release-release-lyrical-laser_geometry-2.11.3-6
...
%changelog
* Thu Jun 04 2026 Nick Schuetz <nschuetz@redhat.com> - 2.11.3-1
