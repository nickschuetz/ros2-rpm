...
Name:           ros-%{ros_distro}-python-cmake-module
Version:        0.12.0
Release:        1%{?dist}
Summary:        ROS 2 Lyrical python_cmake_module

License:        Apache-2.0
URL:            https://github.com/ros2-gbp/python_cmake_module-release
Source0:        https://github.com/ros2-gbp/python_cmake_module-release/archive/refs/tags/release/lyrical/python_cmake_module/0.12.0-3.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
%prep
%autosetup -p1 -n python_cmake_module-release-release-lyrical-python_cmake_module-0.12.0-3
...
%changelog
* Tue Jun 02 2026 Nick Schuetz <nschuetz@redhat.com> - 0.12.0-1
