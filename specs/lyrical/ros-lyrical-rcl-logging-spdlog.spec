...
Version:        3.4.1
Release:        1%{?dist}
Summary:        ROS 2 Lyrical rcl_logging_spdlog

License:        Apache-2.0
URL:            https://github.com/ros2-gbp/rcl_logging-release
Source0:        https://github.com/ros2-gbp/rcl_logging-release/archive/refs/tags/release/lyrical/rcl_logging_spdlog/3.4.1-3.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
%prep
%autosetup -p1 -n rcl_logging-release-release-lyrical-rcl_logging_spdlog-3.4.1-3
...
%changelog
* Tue Jun 02 2026 Nick Schuetz <nschuetz@redhat.com> - 3.4.1-1
