...
Name:           ros-%{ros_distro}-map-msgs
Version:        2.6.1
Release:        1%{?dist}
Summary:        ROS 2 Lyrical map_msgs

License:        BSD-3-Clause
URL:            http://ros.org/wiki/map_msgs
Source0:        https://github.com/ros2-gbp/navigation_msgs-release/archive/refs/tags/release/lyrical/map_msgs/2.6.1-1.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
%prep
%autosetup -p1 -n navigation_msgs-release-release-lyrical-map_msgs-2.6.1-1
...
%changelog
* Thu Jun 04 2026 Nick Schuetz <nschuetz@redhat.com> - 2.6.1-1
