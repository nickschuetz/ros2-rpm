...
Source0:        https://github.com/ros2-gbp/ros2cli-release/archive/refs/tags/release/lyrical/ros2pkg/0.40.8-1.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
%prep
%autosetup -p1 -n ros2cli-release-release-lyrical-ros2pkg-0.40.8-1
