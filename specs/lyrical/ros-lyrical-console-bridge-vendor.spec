...
Version:        1.9.1
Release:        1%{?dist}
Summary:        ROS 2 Lyrical console_bridge_vendor

License:        Apache-2.0
URL:            https://github.com/ros/console_bridge
Source0:        https://github.com/ros2-gbp/console_bridge_vendor-release/archive/refs/tags/release/lyrical/console_bridge_vendor/1.9.1-3.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
%prep
%autosetup -p1 -n console_bridge_vendor-release-release-lyrical-console_bridge_vendor-1.9.1-3
...
%changelog
* Tue Jun 02 2026 Nick Schuetz <nschuetz@redhat.com> - 1.9.1-1
