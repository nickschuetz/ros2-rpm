...
Name:           ros-%{ros_distro}-gz-utils-vendor
Version:        0.4.1
Release:        1%{?dist}
Summary:        ROS 2 Lyrical gz_utils_vendor
...
%prep
%autosetup -p1 -n gz_utils_vendor-release-release-lyrical-gz_utils_vendor-0.4.1-3
...
%changelog
* Thu Jun 04 2026 Nick Schuetz <nschuetz@redhat.com> - 0.4.1-1
