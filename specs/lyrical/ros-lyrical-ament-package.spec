...
Version:        0.18.3
Release:        1%{?dist}
Summary:        ROS 2 Lyrical ament_package

License:        Apache-2.0
URL:            https://github.com/ament/ament_package
Source0:        https://github.com/ament/ament_package/archive/refs/tags/0.18.3.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
%description
The parser for the manifest files in the ament build system.

%prep
%autosetup -p1 -n ament_package-0.18.3
...
%changelog
* Tue Jun 02 2026 Nick Schuetz <nschuetz@redhat.com> - 0.18.3-1
