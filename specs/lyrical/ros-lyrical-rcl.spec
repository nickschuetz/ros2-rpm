...
Name:           ros-%{ros_distro}-rcl
Version:        10.4.4
Release:        1%{?dist}
Summary:        ROS 2 Lyrical rcl

License:        Apache-2.0
URL:            https://github.com/ros2-gbp/rcl-release
Source0:        https://github.com/ros2-gbp/rcl-release/archive/refs/tags/release/lyrical/rcl/10.4.4-1.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
BuildRequires:  ros-lyrical-libyaml-vendor
BuildRequires:  ros-lyrical-rcl-interfaces
BuildRequires:  ros-lyrical-rcl-logging-interface
BuildRequires:  ros-lyrical-rcl-logging-spdlog
BuildRequires:  ros-lyrical-rcl-yaml-param-parser
BuildRequires:  ros-lyrical-rcutils
BuildRequires:  ros-lyrical-rmw-implementation
BuildRequires:  ros-lyrical-rosidl-runtime-c
BuildRequires:  ros-lyrical-service-msgs
BuildRequires:  ros-lyrical-tracetools
BuildRequires:  ros-lyrical-type-description-interfaces

Requires:       libyaml
Requires:       ros-lyrical-libyaml-vendor
Requires:       ros-lyrical-rcl-interfaces
Requires:       ros-lyrical-rcl-logging-interface
Requires:       ros-lyrical-rcl-logging-spdlog
Requires:       ros-lyrical-rcl-yaml-param-parser
...
Requires:       ros-lyrical-type-description-interfaces
...
%description
The ROS client library common implementation. This package contains an API
which builds on the ROS middleware API and is optionally built upon by the
other ROS client libraries.

%prep
%autosetup -p1 -n rcl-release-release-lyrical-rcl-10.4.4-1
