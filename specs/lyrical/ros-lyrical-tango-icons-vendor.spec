...
Version:        0.5.1
Release:        1%{?dist}
Summary:        ROS 2 Lyrical tango_icons_vendor

License:        Apache-2.0
URL:            http://ros.org/wiki/qt_gui_icons
Source0:        https://github.com/ros2-gbp/tango_icons_vendor-release/archive/refs/tags/release/lyrical/tango_icons_vendor/0.5.1-3.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
%prep
%autosetup -p1 -n tango_icons_vendor-release-release-lyrical-tango_icons_vendor-0.5.1-3
