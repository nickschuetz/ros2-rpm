...
%global pkg_name         rosidl_runtime_cpp
%bcond fedora_fhs 0
%if %{with fedora_fhs}
...
Version:        5.2.0
Release:        1%{?dist}
Summary:        ROS 2 Lyrical rosidl_runtime_cpp
...
%description
Provides definitions and templated functions for getting and working with
...
pushd rosidl_runtime_cpp > /dev/null
%cmake \
...
# Header-only C++ runtime: ships headers only, no compiled library.
