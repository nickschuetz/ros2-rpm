...
Name:           ros-%{ros_distro}-rcl-action
Version:        10.4.4
Release:        1%{?dist}
Summary:        ROS 2 Lyrical rcl_action

License:        Apache-2.0
URL:            https://github.com/ros2-gbp/rcl-release
Source0:        https://github.com/ros2-gbp/rcl-release/archive/refs/tags/release/lyrical/rcl_action/10.4.4-1.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
%prep
%autosetup -p1 -n rcl-release-release-lyrical-rcl_action-10.4.4-1
