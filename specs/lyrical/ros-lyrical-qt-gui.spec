...
Version:        2.11.1
Release:        1%{?dist}
Summary:        ROS 2 Lyrical qt_gui

License:        BSD-3-Clause
URL:            http://ros.org/wiki/qt_gui
Source0:        https://github.com/ros2-gbp/qt_gui_core-release/archive/refs/tags/release/lyrical/qt_gui/2.11.1-1.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
Requires:       ros-lyrical-tango-icons-vendor
