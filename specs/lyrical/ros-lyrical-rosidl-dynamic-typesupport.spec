...
Version:        0.4.1
Release:        1%{?dist}
Summary:        ROS 2 Lyrical rosidl_dynamic_typesupport

License:        Apache-2.0
URL:            https://github.com/ros2-gbp/rosidl_dynamic_typesupport-release
Source0:        https://github.com/ros2-gbp/rosidl_dynamic_typesupport-release/archive/refs/tags/release/lyrical/rosidl_dynamic_typesupport/0.4.1-3.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
%prep
%autosetup -p1 -n rosidl_dynamic_typesupport-release-release-lyrical-rosidl_dynamic_typesupport-0.4.1-3
...
%changelog
* Tue Jun 02 2026 Nick Schuetz <nschuetz@redhat.com> - 0.4.1-1
