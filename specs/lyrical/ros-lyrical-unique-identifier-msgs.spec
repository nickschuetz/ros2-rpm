...
Name:           ros-%{ros_distro}-unique-identifier-msgs
Version:        2.8.1
Release:        1%{?dist}
Summary:        ROS 2 Lyrical unique_identifier_msgs

License:        BSD-3-Clause
URL:            http://ros.org/wiki/unique_identifier_msgs
Source0:        https://github.com/ros2-gbp/unique_identifier_msgs-release/archive/refs/tags/release/lyrical/unique_identifier_msgs/2.8.1-3.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
%prep
%autosetup -p1 -n unique_identifier_msgs-release-release-lyrical-unique_identifier_msgs-2.8.1-3
...
%changelog
* Tue Jun 02 2026 Nick Schuetz <nschuetz@redhat.com> - 2.8.1-1
