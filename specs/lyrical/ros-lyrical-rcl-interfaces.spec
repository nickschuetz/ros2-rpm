...
Name:           ros-%{ros_distro}-rcl-interfaces
Version:        2.4.5
Release:        1%{?dist}
Summary:        ROS 2 Lyrical rcl_interfaces

License:        Apache-2.0
URL:            https://github.com/ros2-gbp/rcl_interfaces-release
Source0:        https://github.com/ros2-gbp/rcl_interfaces-release/archive/refs/tags/release/lyrical/rcl_interfaces/2.4.5-1.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
messages and services which ROS client libraries will use under the hood to
communicate higher level concepts such as parameters.

%prep
%autosetup -p1 -n rcl_interfaces-release-release-lyrical-rcl_interfaces-2.4.5-1
