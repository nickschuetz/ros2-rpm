...
Version:        1.13.3
Release:        1%{?dist}
Summary:        ROS 2 Lyrical ament_index_python

License:        Apache-2.0
URL:            https://github.com/ros2-gbp/ament_index-release
Source0:        https://github.com/ros2-gbp/ament_index-release/archive/refs/tags/release/lyrical/ament_index_python/1.13.3-3.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
%prep
%autosetup -p1 -n ament_index-release-release-lyrical-ament_index_python-1.13.3-3
...
%changelog
* Tue Jun 02 2026 Nick Schuetz <nschuetz@redhat.com> - 1.13.3-1
