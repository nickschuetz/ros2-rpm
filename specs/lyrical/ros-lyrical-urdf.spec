...
Name:           ros-%{ros_distro}-urdf
Version:        2.13.2
Release:        1%{?dist}
Summary:        ROS 2 Lyrical urdf

License:        BSD-3-Clause
URL:            https://github.com/ros2/urdf
Source0:        https://github.com/ros2-gbp/urdf-release/archive/refs/tags/release/lyrical/urdf/2.13.2-3.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
(URDF), which is an XML format for representing a robot model. The code API
of the parser has been through our review process and will remain backwards
compatible in future releases.

%prep
%autosetup -p1 -n urdf-release-release-lyrical-urdf-2.13.2-3
