...
Name:           ros-%{ros_distro}-vision-msgs
Version:        4.2.0
Release:        1%{?dist}
Summary:        ROS 2 Lyrical vision_msgs

License:        Apache-2.0
URL:            https://github.com/ros2-gbp/vision_msgs-release
Source0:        https://github.com/ros2-gbp/vision_msgs-release/archive/refs/tags/release/lyrical/vision_msgs/4.2.0-3.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
%prep
%autosetup -p1 -n vision_msgs-release-release-lyrical-vision_msgs-4.2.0-3
...
%changelog
* Tue Jun 02 2026 Nick Schuetz <nschuetz@redhat.com> - 4.2.0-1
