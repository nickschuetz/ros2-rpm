...
Version:        0.14.1
Release:        1%{?dist}
Summary:        ROS 2 Lyrical example_interfaces

License:        Apache-2.0
URL:            https://github.com/ros2-gbp/example_interfaces-release
Source0:        https://github.com/ros2-gbp/example_interfaces-release/archive/refs/tags/release/lyrical/example_interfaces/0.14.1-3.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
%prep
%autosetup -p1 -n example_interfaces-release-release-lyrical-example_interfaces-0.14.1-3
...
%changelog
* Wed Jun 03 2026 Nick Schuetz <nschuetz@redhat.com> - 0.14.1-1
