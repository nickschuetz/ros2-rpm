...
Version:        0.11.3
Release:        1%{?dist}
Summary:        ROS 2 Lyrical tinyxml2_vendor

License:        Apache-2.0
URL:            https://github.com/ros2-gbp/tinyxml2_vendor-release
Source0:        https://github.com/ros2-gbp/tinyxml2_vendor-release/archive/refs/tags/release/lyrical/tinyxml2_vendor/0.11.3-3.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
%prep
%autosetup -p1 -n tinyxml2_vendor-release-release-lyrical-tinyxml2_vendor-0.11.3-3
...
%changelog
* Wed Jun 03 2026 Nick Schuetz <nschuetz@redhat.com> - 0.11.3-1
