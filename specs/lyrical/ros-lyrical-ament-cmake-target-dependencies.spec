...
Version:        2.8.7
Release:        1%{?dist}
Summary:        ROS 2 Lyrical ament_cmake_target_dependencies
...
Requires:       ros-lyrical-ament-cmake-include-directories
...
pushd ament_cmake_target_dependencies > /dev/null
%cmake \
