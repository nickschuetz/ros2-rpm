...
Version:        2.1.7
Release:        1%{?dist}
Summary:        ROS 2 Lyrical osrf_pycommon

License:        Apache-2.0
URL:            https://github.com/ros2-gbp/osrf_pycommon-release
Source0:        https://github.com/ros2-gbp/osrf_pycommon-release/archive/refs/tags/release/lyrical/osrf_pycommon/2.1.7-3.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
%prep
%autosetup -p1 -n osrf_pycommon-release-release-lyrical-osrf_pycommon-2.1.7-3
...
%changelog
* Wed Jun 03 2026 Nick Schuetz <nschuetz@redhat.com> - 2.1.7-1
