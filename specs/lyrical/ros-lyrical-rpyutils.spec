...
Name:           ros-%{ros_distro}-rpyutils
Version:        0.7.2
Release:        1%{?dist}
Summary:        ROS 2 Lyrical rpyutils

License:        Apache-2.0
URL:            https://github.com/ros2-gbp/rpyutils-release
Source0:        https://github.com/ros2-gbp/rpyutils-release/archive/refs/tags/release/lyrical/rpyutils/0.7.2-3.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
%prep
%autosetup -p1 -n rpyutils-release-release-lyrical-rpyutils-0.7.2-3
...
%changelog
* Tue Jun 02 2026 Nick Schuetz <nschuetz@redhat.com> - 0.7.2-1
