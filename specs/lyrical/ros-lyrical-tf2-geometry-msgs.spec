...
Name:           ros-%{ros_distro}-tf2-geometry-msgs
Version:        0.45.9
Release:        1%{?dist}
Summary:        ROS 2 Lyrical tf2_geometry_msgs

License:        BSD-3-Clause
URL:            http://www.ros.org/wiki/tf2_ros
Source0:        https://github.com/ros2-gbp/geometry2-release/archive/refs/tags/release/lyrical/tf2_geometry_msgs/0.45.9-1.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
%prep
%autosetup -p1 -n geometry2-release-release-lyrical-tf2_geometry_msgs-0.45.9-1
...
# Header-only C++ (headers) + a pure-Python module; no compiled library, so the
# package is noarch and ships no lib/lib*.so.
%{install_prefix}/include/%{pkg_name}/


%changelog
* Tue Aug 25 2026 Nick Schuetz <nschuetz@redhat.com> - 0.45.9-1
- Sync with upstream lyrical: 0.45.9.

* Mon Jul 27 2026 Nick Schuetz <nschuetz@redhat.com> - 0.45.8-1
- Sync with upstream lyrical: 0.45.8.

* Thu Jun 04 2026 Nick Schuetz <nschuetz@redhat.com> - 0.45.7-1
