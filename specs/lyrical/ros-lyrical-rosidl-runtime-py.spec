...
Version:        0.15.2
Release:        1%{?dist}
Summary:        ROS 2 Lyrical rosidl_runtime_py

License:        Apache-2.0
URL:            https://github.com/ros2-gbp/rosidl_runtime_py-release
Source0:        https://github.com/ros2-gbp/rosidl_runtime_py-release/archive/refs/tags/release/lyrical/rosidl_runtime_py/0.15.2-3.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
Requires:       ros-lyrical-rosidl-buffer-py
...
%prep
%autosetup -p1 -n rosidl_runtime_py-release-release-lyrical-rosidl_runtime_py-0.15.2-3
...
%changelog
* Wed Jun 03 2026 Nick Schuetz <nschuetz@redhat.com> - 0.15.2-1
