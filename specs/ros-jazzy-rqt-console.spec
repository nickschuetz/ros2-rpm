...
%global pkg_name         rqt_console
%global install_prefix   /opt/ros/jazzy

Name:           ros-%{ros_distro}-rqt-console
Version:        2.2.2
Release:        1%{?dist}
Summary:        ROS 2 Jazzy rqt_console

License:        BSD-3-Clause
URL:            http://wiki.ros.org/rqt_console
Source0:        https://github.com/ros2-gbp/rqt_console-release/archive/refs/tags/release/jazzy/rqt_console/2.2.2-1.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
%prep
%autosetup -p1 -n rqt_console-release-release-jazzy-rqt_console-2.2.2-1
