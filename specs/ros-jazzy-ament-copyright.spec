...
Version:        0.17.5
Release:        1%{?dist}
Summary:        ROS 2 Jazzy ament_copyright

License:        Apache-2.0
URL:            https://github.com/ros2-gbp/ament_lint-release
Source0:        https://github.com/ros2-gbp/ament_lint-release/archive/refs/tags/release/jazzy/ament_copyright/0.17.5-1.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
%prep
%autosetup -p1 -n ament_lint-release-release-jazzy-ament_copyright-0.17.5-1
...
%changelog
* Fri May 08 2026 Nick Schuetz <nschuetz@redhat.com> - 0.17.5-1
