...
Version:        1.6.3
Release:        1%{?dist}
Summary:        ROS 2 Jazzy rqt_gui_py

License:        BSD-3-Clause
URL:            http://ros.org/wiki/rqt_gui_py
Source0:        https://github.com/ros2-gbp/rqt-release/archive/refs/tags/release/jazzy/rqt_gui_py/1.6.3-1.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
BuildRequires:  ros-jazzy-qt-gui
