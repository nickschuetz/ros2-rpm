...
%global pkg_name         ament_cmake_gtest
%global install_prefix   /opt/ros/jazzy

Name:           ros-%{ros_distro}-ament-cmake-gtest
Version:        2.5.6
Release:        1%{?dist}
Summary:        ROS 2 Jazzy ament_cmake_gtest
...
%description
The ability to add gtest-based tests in the ament build system in CMake.
...
pushd ament_cmake_gtest > /dev/null
%cmake \
...
%files
%license LICENSE
%doc ament_cmake_gtest/CHANGELOG.rst
