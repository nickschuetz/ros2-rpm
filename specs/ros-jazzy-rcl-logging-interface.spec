...
Version:        3.1.1
Release:        1%{?dist}
Summary:        ROS 2 Jazzy rcl_logging_interface

License:        Apache-2.0
URL:            https://github.com/ros2-gbp/rcl_logging-release
Source0:        https://github.com/ros2-gbp/rcl_logging-release/archive/refs/tags/release/jazzy/rcl_logging_interface/3.1.1-1.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
%prep
%autosetup -p1 -n rcl_logging-release-release-jazzy-rcl_logging_interface-3.1.1-1
