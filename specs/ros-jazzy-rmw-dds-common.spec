...
Version:        3.1.1
Release:        1%{?dist}
Summary:        ROS 2 Jazzy rmw_dds_common

License:        Apache-2.0
URL:            https://github.com/ros2-gbp/rmw_dds_common-release
Source0:        https://github.com/ros2-gbp/rmw_dds_common-release/archive/refs/tags/release/jazzy/rmw_dds_common/3.1.1-1.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
%prep
%autosetup -p1 -n rmw_dds_common-release-release-jazzy-rmw_dds_common-3.1.1-1
