...
Source0:        https://github.com/ros2-gbp/rqt_publisher-release/archive/refs/tags/release/jazzy/rqt_publisher/1.7.3-1.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
%prep
%autosetup -p1 -n rqt_publisher-release-release-jazzy-rqt_publisher-1.7.3-1
