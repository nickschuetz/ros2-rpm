...
%global pkg_name         ament_cmake_include_directories
%global install_prefix   /opt/ros/jazzy

Name:           ros-%{ros_distro}-ament-cmake-include-directories
Version:        2.5.6
Release:        1%{?dist}
Summary:        ROS 2 Jazzy ament_cmake_include_directories
...
%description
The functionality to order include directories according to a chain of
prefixes in the ament build system in CMake.
...
pushd ament_cmake_include_directories
%cmake \
...
%files
%license LICENSE
%doc ament_cmake_include_directories/CHANGELOG.rst
