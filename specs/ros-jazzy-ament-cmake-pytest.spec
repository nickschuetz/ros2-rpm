...
%global pkg_name         ament_cmake_pytest
%global install_prefix   /opt/ros/jazzy

Name:           ros-%{ros_distro}-ament-cmake-pytest
Version:        2.5.6
Release:        1%{?dist}
Summary:        ROS 2 Jazzy ament_cmake_pytest
...
%description
The ability to run Python tests using pytest in the ament build system in
CMake.
...
pushd ament_cmake_pytest > /dev/null
%cmake \
...
%files
%license LICENSE
%doc ament_cmake_pytest/CHANGELOG.rst
