...
Version:        0.2.1
Release:        1%{?dist}
Summary:        ROS 2 Jazzy rosidl_core_generators

License:        Apache-2.0
URL:            https://github.com/ros2-gbp/rosidl_core-release
Source0:        https://github.com/ros2-gbp/rosidl_core-release/archive/refs/tags/release/jazzy/rosidl_core_generators/0.2.1-1.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
%prep
%autosetup -p1 -n rosidl_core-release-release-jazzy-rosidl_core_generators-0.2.1-1
