...
%global pkg_name         gazebo_msgs
%global install_prefix   /opt/ros/jazzy

Name:           ros-%{ros_distro}-gazebo-msgs
Version:        3.8.0
Release:        1%{?dist}
Summary:        ROS 2 Jazzy gazebo_msgs

License:        BSD-3-Clause
URL:            http://gazebosim.org/tutorials?cat=connect_ros
Source0:        https://github.com/ros2-gbp/gazebo_ros_pkgs-release/archive/refs/tags/release/jazzy/gazebo_msgs/3.8.0-1.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
%prep
%autosetup -p1 -n gazebo_ros_pkgs-release-release-jazzy-gazebo_msgs-3.8.0-1
...
%changelog
* Fri May 08 2026 Nick Schuetz <nschuetz@redhat.com> - 3.8.0-1
