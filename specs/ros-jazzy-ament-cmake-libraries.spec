...
%global pkg_name         ament_cmake_libraries
%global install_prefix   /opt/ros/jazzy

Name:           ros-%{ros_distro}-ament-cmake-libraries
Version:        2.5.6
Release:        1%{?dist}
Summary:        ROS 2 Jazzy ament_cmake_libraries
...
%description
The functionality to deduplicate libraries in the ament build system in
CMake.
...
%files
%license LICENSE
%doc ament_cmake_libraries/CHANGELOG.rst
