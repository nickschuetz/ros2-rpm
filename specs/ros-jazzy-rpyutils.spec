...
Version:        0.4.2
Release:        1%{?dist}
Summary:        ROS 2 Jazzy rpyutils

License:        Apache-2.0
URL:            https://github.com/ros2-gbp/rpyutils-release
Source0:        https://github.com/ros2-gbp/rpyutils-release/archive/refs/tags/release/jazzy/rpyutils/0.4.2-1.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
%prep
%autosetup -p1 -n rpyutils-release-release-jazzy-rpyutils-0.4.2-1
...
%changelog
* Fri May 08 2026 Nick Schuetz <nschuetz@redhat.com> - 0.4.2-1
