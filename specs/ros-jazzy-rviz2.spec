...
Version:        14.1.20
Release:        1%{?dist}
Summary:        ROS 2 Jazzy rviz2

License:        BSD-3-Clause
URL:            https://github.com/ros2/rviz/blob/ros2/README.md
Source0:        https://github.com/ros2-gbp/rviz-release/archive/refs/tags/release/jazzy/rviz2/14.1.20-2.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
%prep
%autosetup -p1 -n rviz-release-release-jazzy-rviz2-14.1.20-2
