...
Version:        1.7.5
Release:        1%{?dist}
Summary:        ROS 2 Jazzy rqt_topic

License:        BSD-3-Clause
URL:            http://wiki.ros.org/rqt_topic
Source0:        https://github.com/ros2-gbp/rqt_topic-release/archive/refs/tags/release/jazzy/rqt_topic/1.7.5-1.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
%prep
%autosetup -p1 -n rqt_topic-release-release-jazzy-rqt_topic-1.7.5-1
...
%changelog
* Fri May 08 2026 Nick Schuetz <nschuetz@redhat.com> - 1.7.5-1
