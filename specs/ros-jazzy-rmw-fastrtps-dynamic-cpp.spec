...
Version:        8.4.3
Release:        1%{?dist}
Summary:        ROS 2 Jazzy rmw_fastrtps_dynamic_cpp

License:        Apache-2.0
URL:            https://github.com/ros2-gbp/rmw_fastrtps-release
Source0:        https://github.com/ros2-gbp/rmw_fastrtps-release/archive/refs/tags/release/jazzy/rmw_fastrtps_dynamic_cpp/8.4.3-1.tar.gz#/%{pkg_name}-%{version}.tar.gz
