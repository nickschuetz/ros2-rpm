...
%global pkg_name         ament_cmake_export_link_flags
%global install_prefix   /opt/ros/jazzy

Name:           ros-%{ros_distro}-ament-cmake-export-link-flags
Version:        2.5.6
Release:        1%{?dist}
Summary:        ROS 2 Jazzy ament_cmake_export_link_flags
...
%description
The ability to export link flags to downstream packages in the ament build
system.
...
pushd ament_cmake_export_link_flags
%cmake \
...
%files
%license LICENSE
%doc ament_cmake_export_link_flags/CHANGELOG.rst
