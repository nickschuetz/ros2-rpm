...
Version:        2.0.2
Release:        1%{?dist}
Summary:        ROS 2 Jazzy ackermann_msgs

License:        BSD-3-Clause
URL:            https://github.com/ros2-gbp/ackermann_msgs-release
Source0:        https://github.com/ros2-gbp/ackermann_msgs-release/archive/refs/tags/release/jazzy/ackermann_msgs/2.0.2-6.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
%prep
%autosetup -p1 -n ackermann_msgs-release-release-jazzy-ackermann_msgs-2.0.2-6
...
%changelog
* Fri May 08 2026 Nick Schuetz <nschuetz@redhat.com> - 2.0.2-1
