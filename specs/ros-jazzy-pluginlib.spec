...
Version:        5.4.5
Release:        1%{?dist}
Summary:        ROS 2 Jazzy pluginlib

License:        BSD-3-Clause
URL:            http://www.ros.org/wiki/pluginlib
Source0:        https://github.com/ros2-gbp/pluginlib-release/archive/refs/tags/release/jazzy/pluginlib/5.4.5-1.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
%prep
%autosetup -p1 -n pluginlib-release-release-jazzy-pluginlib-5.4.5-1
...
# pluginlib is INTERFACE (header-only) — no .so. Ships only list_plugins
# CLI under lib/pluginlib/.
%{install_prefix}/lib/%{pkg_name}/


%changelog
* Fri May 08 2026 Nick Schuetz <nschuetz@redhat.com> - 5.4.5-1
