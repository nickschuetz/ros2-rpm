...
Version:        2.0.3
Release:        1%{?dist}
Summary:        ROS 2 Jazzy service_msgs

License:        Apache-2.0
URL:            https://github.com/ros2-gbp/rcl_interfaces-release
Source0:        https://github.com/ros2-gbp/rcl_interfaces-release/archive/refs/tags/release/jazzy/service_msgs/2.0.3-1.tar.gz#/%{pkg_name}-%{version}.tar.gz
