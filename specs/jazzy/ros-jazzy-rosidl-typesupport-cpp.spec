...
Source0:        https://github.com/ros2-gbp/rosidl_typesupport-release/archive/refs/tags/release/jazzy/rosidl_typesupport_cpp/3.2.3-1.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
%prep
%autosetup -p1 -n rosidl_typesupport-release-release-jazzy-rosidl_typesupport_cpp-3.2.3-1
