...
Version:        9.2.11
Release:        1%{?dist}
Summary:        ROS 2 Jazzy rcl_action

License:        Apache-2.0
URL:            https://github.com/ros2-gbp/rcl-release
Source0:        https://github.com/ros2-gbp/rcl-release/archive/refs/tags/release/jazzy/rcl_action/9.2.11-1.tar.gz#/%{pkg_name}-%{version}.tar.gz
