...
Source0:        https://github.com/ros2-gbp/rcl_interfaces-release/archive/refs/tags/release/jazzy/type_description_interfaces/2.0.4-1.tar.gz#/%{pkg_name}-%{version}.tar.gz
