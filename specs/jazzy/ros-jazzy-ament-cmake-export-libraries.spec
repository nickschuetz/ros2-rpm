...
%global pkg_name         ament_cmake_export_libraries
%global install_prefix   /opt/ros/jazzy

Name:           ros-%{ros_distro}-ament-cmake-export-libraries
Version:        2.5.6
Release:        1%{?dist}
Summary:        ROS 2 Jazzy ament_cmake_export_libraries
...
%description
The ability to export libraries to downstream packages in the ament build
system in CMake.
...
pushd ament_cmake_export_libraries
%cmake \
...
%files
%license LICENSE
%doc ament_cmake_export_libraries/CHANGELOG.rst
