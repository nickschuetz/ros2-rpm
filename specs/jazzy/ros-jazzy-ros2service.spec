...
Version:        0.32.10
Release:        1%{?dist}
Summary:        ROS 2 Jazzy ros2service

License:        Apache-2.0
URL:            https://github.com/ros2-gbp/ros2cli-release
Source0:        https://github.com/ros2-gbp/ros2cli-release/archive/refs/tags/release/jazzy/ros2service/0.32.10-1.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
%prep
%autosetup -p1 -n ros2cli-release-release-jazzy-ros2service-0.32.10-1
