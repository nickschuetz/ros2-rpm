...
Version:        5.3.7
Release:        1%{?dist}
Summary:        ROS 2 Jazzy sensor_msgs

License:        Apache-2.0
URL:            https://github.com/ros2-gbp/common_interfaces-release
Source0:        https://github.com/ros2-gbp/common_interfaces-release/archive/refs/tags/release/jazzy/sensor_msgs/5.3.7-1.tar.gz#/%{pkg_name}-%{version}.tar.gz
