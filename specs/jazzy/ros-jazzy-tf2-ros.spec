...
Source0:        https://github.com/ros2-gbp/geometry2-release/archive/refs/tags/release/jazzy/tf2_ros/0.36.22-1.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
%prep
%autosetup -p1 -n geometry2-release-release-jazzy-tf2_ros-0.36.22-1
