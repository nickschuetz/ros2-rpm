...
%global pkg_name         ament_cmake
%global install_prefix   /opt/ros/jazzy

Name:           ros-%{ros_distro}-ament-cmake
Version:        2.5.6
Release:        1%{?dist}
Summary:        ROS 2 Jazzy ament_cmake
...
Requires:       ros-jazzy-ament-cmake-export-definitions
Requires:       ros-jazzy-ament-cmake-export-dependencies
Requires:       ros-jazzy-ament-cmake-export-include-directories
Requires:       ros-jazzy-ament-cmake-export-interfaces
Requires:       ros-jazzy-ament-cmake-export-libraries
Requires:       ros-jazzy-ament-cmake-export-link-flags
Requires:       ros-jazzy-ament-cmake-export-targets
Requires:       ros-jazzy-ament-cmake-gen-version-h
Requires:       ros-jazzy-ament-cmake-libraries
Requires:       ros-jazzy-ament-cmake-python
Requires:       ros-jazzy-ament-cmake-target-dependencies
Requires:       ros-jazzy-ament-cmake-test
Requires:       ros-jazzy-ament-cmake-version

%global __provides_exclude_from ^%{install_prefix}/.*$
%global __requires_exclude_from ^%{install_prefix}/.*$

%description
The entry point package for the ament build system in CMake.
