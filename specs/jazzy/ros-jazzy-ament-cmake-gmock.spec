...
%global pkg_name         ament_cmake_gmock
%global install_prefix   /opt/ros/jazzy

Name:           ros-%{ros_distro}-ament-cmake-gmock
Version:        2.5.6
Release:        1%{?dist}
Summary:        ROS 2 Jazzy ament_cmake_gmock
...
%description
The ability to add Google mock-based tests in the ament build system in
CMake.
...
pushd ament_cmake_gmock > /dev/null
%cmake \
...
%files
%license LICENSE
%doc ament_cmake_gmock/CHANGELOG.rst
