...
Name:           ros-%{ros_distro}-rqt-action
Version:        2.2.1
Release:        2%{?dist}
Summary:        ROS 2 Jazzy rqt_action

License:        BSD-3-Clause
URL:            http://wiki.ros.org/rqt_action
Source0:        https://github.com/ros2-gbp/rqt_action-release/archive/refs/tags/release/jazzy/rqt_action/2.2.1-1.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
%prep
%autosetup -p1 -n rqt_action-release-release-jazzy-rqt_action-2.2.1-1
...
%changelog
* Wed Aug 26 2026 Nick Schuetz <nschuetz@redhat.com> - 2.2.1-2
...
* Fri May 08 2026 Nick Schuetz <nschuetz@redhat.com> - 2.2.1-1
