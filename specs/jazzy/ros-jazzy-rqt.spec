...
Source0:        https://github.com/ros2-gbp/rqt-release/archive/refs/tags/release/jazzy/rqt/1.6.4-1.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
%prep
%autosetup -p1 -n rqt-release-release-jazzy-rqt-1.6.4-1
