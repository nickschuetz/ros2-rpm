...
%global pkg_name         rosidl_default_runtime
%bcond fedora_fhs 0
%if %{with fedora_fhs}
...
Version:        1.6.1
Release:        1%{?dist}
Summary:        ROS 2 Jazzy rosidl_default_runtime

License:        Apache-2.0
URL:            https://github.com/ros2-gbp/rosidl_defaults-release
Source0:        https://github.com/ros2-gbp/rosidl_defaults-release/archive/refs/tags/release/jazzy/rosidl_default_runtime/1.6.1-1.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
%changelog
* Thu Jun 25 2026 Nick Schuetz <nschuetz@redhat.com> - 1.6.1-1
- Sync with upstream jazzy: 1.6.1.
