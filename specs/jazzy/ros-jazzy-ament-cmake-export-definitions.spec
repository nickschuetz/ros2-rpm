...
%global pkg_name         ament_cmake_export_definitions
%global install_prefix   /opt/ros/jazzy

Name:           ros-%{ros_distro}-ament-cmake-export-definitions
Version:        2.5.6
Release:        1%{?dist}
Summary:        ROS 2 Jazzy ament_cmake_export_definitions
...
%description
The ability to export definitions to downstream packages in the ament build
system.
...
pushd ament_cmake_export_definitions
%cmake \
...
%files
%license LICENSE
%doc ament_cmake_export_definitions/CHANGELOG.rst
