...
Version:        0.1.0
Release:        1%{?dist}
Summary:        ROS 2 Jazzy rosidl_dynamic_typesupport_fastrtps

License:        Apache-2.0
URL:            https://github.com/ros2-gbp/rosidl_dynamic_typesupport_fastrtps-release
Source0:        https://github.com/ros2-gbp/rosidl_dynamic_typesupport_fastrtps-release/archive/refs/tags/release/jazzy/rosidl_dynamic_typesupport_fastrtps/0.1.0-3.tar.gz#/%{pkg_name}-%{version}.tar.gz
...
%prep
%autosetup -p1 -n rosidl_dynamic_typesupport_fastrtps-release-release-jazzy-rosidl_dynamic_typesupport_fastrtps-0.1.0-3
...
%changelog
* Fri May 08 2026 Nick Schuetz <nschuetz@redhat.com> - 0.1.0-1
