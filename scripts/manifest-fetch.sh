#!/usr/bin/env bash
# manifest-fetch.sh, refresh distros/<distro>/manifest.yaml pins from rosdistro.
...
echo "  4. Write back to $MANIFEST; emit a diff for review."
