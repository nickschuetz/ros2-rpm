...
echo "     Source0, BuildArch. Reference: specs/jazzy/ros-jazzy-ament-package.spec."
echo "  6. cp rpm/template.spec ../../specs/<distro>/ros-<distro>-<pkg-dashed>.spec"
echo "  7. Download Source0 tarball into build/SOURCES/"
echo "  8. ../../scripts/build-one.sh ros-<distro>-<pkg-dashed>"
echo
...
echo "specs/<distro>/ as the canonical example."
