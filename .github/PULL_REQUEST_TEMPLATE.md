...
- [ ] If this PR adds, updates, or removes a packaged component, the distro's `distros/<distro>/manifest.yaml` is updated with new pins.
...
- [ ] CI build is green on all 6 chroot/arch pairs (per distro project; see ADR 0010).
